 ...
 * @author Pablo
 */
public class AgregarEnCrearLista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("true".equals(sesion.getAttribute("loged").toString())) {
            ...
            try {
                ...
                if (auxUser != null) {
                    auxLista.setNombreLista(request.getParameter("nombrelista"));
                    auxLista.setUsuarioidUsuario(auxUser);
                    orm.ListaDAO.save(auxLista);

                    //Entrada de la lista
                    orm.EntradaLista el = orm.EntradaListaDAO.createEntradaLista();
                    el.setListaidLista(auxLista);
            ...
            RequestDispatcher disp = request.getRequestDispatcher(request.getParameter("origen"));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AgregarEnCrearLista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
