...
public class SerieGenericaSetCollection extends org.orm.util.ORMSet {
	...
	*/
	 ...
	 */
	public void add(SerieGenerica value) {
		if (value != null) {
	 ...
	 * @param value the persistent object
	 */
	public void remove(SerieGenerica value) {
	 ...
	 */
	public boolean contains(SerieGenerica value) {
	 ...
	 */
	public SerieGenerica[] toArray() {
		return (SerieGenerica[]) super.toArray(new SerieGenerica[size()]);
	}
	 ...
	 */
	public SerieGenerica[] toArray(String propertyName) {
	 ...
	 * @return The persistent objects sorted array
	 */
	public SerieGenerica[] toArray(String propertyName, boolean ascending) {
